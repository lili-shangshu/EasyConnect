...
@protocol SCNavigationDelegate <NSObject>

- (void)willSelectIndex:(NSInteger)index viewController:(UIViewController *)controller;
...
// Could not set [UIColor clear], if you set, NavTabbar will show initialize color
...
@property (nonatomic, assign)   NSInteger currentIndex;              // current page index
@property (nonatomic, strong) id <SCNavigationDelegate> delegate;


- (id)initWithtabBarColor:(UIColor *)blackColor;
/**
 *  Initialize Methods
 *
