...
- (void)viewDidLoad {
    ...
    [self testData];
    //
    //    UIImageView *imgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 140, self.view.bounds.size.width, 300.f)];
    //    imgView.image = [UIImage imageNamed:@"expandableImage"];
