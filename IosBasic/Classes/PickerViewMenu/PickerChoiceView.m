...
- (void)cancelBtnClick{
    ...
    [self.delegate PickerSelectorIndixString:nil WithOrderId:_orderId];
    [self hideAnimation];
}
...
//     [self.delegate PickerSelectorIndixString:fullStr];
    ...
    [self.delegate PickerSelectorIndixString:fullStr WithOrderId:_orderId];
